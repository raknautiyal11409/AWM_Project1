...
MAINTAINER Rakshit Nautiyal

ENV PYTHONUNBUFFERED 1
ENV DJANGO_SETTINGS_MODULE=LAB_3.settings
...
# You should have already exported your conda environment to an "ENV1.yml" file.
